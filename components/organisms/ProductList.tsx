    ...
    return (
        <div className="space-y-5">
            {categories.map(category => (
                <>
                    <h2 className="text-4xl font-bold text-darkblue mt-2 md:mt-12 mb-5 md:mb-10 md:container md:mx-auto">
                        {category}
                    </h2>
                    <section key={category} className="relative overflow-hidden -mx-4 sm:-mx-6 lg:-mx-8">
                        ...
                        <div className="relative z-10 py-4 md:py-8 px-2 sm:px-4 lg:px-6">
                            <div className="max-w-7xl mx-auto">
                                <div
                                    className="columns-1 md:columns-2 lg:columns-3 gap-0 space-y-0 bg-white/60 rounded-lg p-2 sm:p-4 shadow-sm">
                                    {products
